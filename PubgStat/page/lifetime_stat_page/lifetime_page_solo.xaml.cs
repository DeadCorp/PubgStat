...
namespace PubgStat.page.lifetime_stat_page {
    ...
    public partial class lifetime_page_solo : ContentPage {
        private data_page_view_model vm =  new data_page_view_model();
        public lifetime_page_solo() {
            InitializeComponent();
            this.BindingContext = vm;
            MessagingCenter.Subscribe<search_page,data_page_view_model>(this,"data_ls",(sender,arg) => {
        ...
        async void OnSwiped(object sender,SwipedEventArgs e) {
            switch(e.Direction) {
                ...
                await Shell.Current.GoToAsync("//s_sqt");
                break;
