...
namespace PubgStat.page.lifetime_stat_page {
    ...
    public partial class lifetime_page_duo_tpp : ContentPage {
        private data_page_view_model vm =  new data_page_view_model();
        public lifetime_page_duo_tpp() {
            InitializeComponent();
            this.BindingContext = vm;
            MessagingCenter.Subscribe<search_page,data_page_view_model>(this,"data_ld_t",(sender,arg) => {
